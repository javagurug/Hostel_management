 ...
 * @author choha
 */
public class studentfeesframe extends javax.swing.JFrame {

    /**
     * Creates new form studentfeesframe
     */
    public studentfeesframe() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(615, 0, 79, -1));
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(-50, -200, 1010, 780));
    ...
    private void jbutton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbutton2ActionPerformed
        // TODO add your handling code here:
        studentfeeschoice fr=new studentfeeschoice();
        fr.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentfeesframe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentfeesframe().setVisible(true);
            }
        });
    }
